...
public class EnrollFrame extends JFrame{
	private JLabel name,gender,userID,password,email;
	private JTextField names,ID,PW,mail;
	...
	public void createButton() throws SQLException{
		...
		submit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					insert=connect.prepareStatement("INSERT INTO personalInfo (Name,Gender,UserID,Password,Email) VALUES (?,?,?,?,?)");
					...
					JOptionPane.showMessageDialog(null,"Success!","Info",JOptionPane.OK_OPTION);
					dispose();
